...
plugins=(zsh-vi-mode zsh-syntax-highlighting git docker)
...
alias whost="ip route show | grep -i default | awk '{print \$3}'"
...
# Auto-completing filenames that contain the current text.
